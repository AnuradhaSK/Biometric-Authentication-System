...
public class NewUserUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Set a Username(5-10 characters) ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(username.trim().length()<=10 && username.trim().length()>=5 ){
            try {
                //check validity of username
                if(DBFunction.validateUsername(username)){
                    
                    this.setVisible(false);
                    SignUpForm signup=new SignUpForm(new User(username));
                    signup.setVisible(true);
                }
                else{
                    retry("This username exists :( \n Please try for another username");
                }
            } catch (SQLException ex) {
                Logger.getLogger(NewUserUI.class.getName()).log(Level.SEVERE, null, ex);
            ...
            retry("Please enter a username with 5-10 length");
        }
